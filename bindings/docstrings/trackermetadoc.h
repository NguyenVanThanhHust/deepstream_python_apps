...
namespace pydsdoc
{
    namespace trackerdoc
    {
        ...
        {
            static constexpr auto descr = R"doc(
            ...
            static constexpr auto featureSize = R"doc(
                Each target's ReID vector length.
            )doc";
    
            static constexpr auto numFilled = R"doc(
                Number of reid vectors in the batch.
            )doc";
    
            static constexpr auto ptr_host = R"doc(
                ReID vector on CPU.
            )doc";
    
            static constexpr auto ptr_dev = R"doc(
                ReID vector on GPU.
            )doc";
    
            static constexpr auto priv_data = R"doc(
